...
Sugestão: usar `kube-prometheus-stack` como base (Prometheus, Grafana, Alertmanager) e um OpenTelemetry Collector DaemonSet exportando para CloudWatch Logs e X-Ray.
